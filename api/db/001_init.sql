...
# Registro de routers
# -------------------------------------------------------------------
# Aquí conectamos los bloques funcionales separados del proyecto.
# Así evitamos que main.py crezca demasiado.
# -------------------------------------------------------------------
...
def register(
    ...
    # Limitamos peticiones de registro por IP para evitar abuso masivo
    rate_limit(
        key=f"register:{ip}",
        max_requests=5,
        window_seconds=60
